        ...
        <div className="row">
          <div className="col-lg-4 col-md-6 col-12 text-white">
            ...
            <div className="mb-4">
              ...
              <div className="mt-4">
                <p>
                  HafDev is feature-rich components and beautifully Bootstrap UIKit
          ...
          <div className="col-lg-3 col-md-12">
            ...
            <div className="mb-4">
              ...
              <p>000 Magomeni, Zanzibar</p>
              <p className="mb-1">
                Email:
                <a href="#" className='text-white'> hafidhmwita@gmail.com</a>
              </p>
              <p>
                Phone:
                <span className="text-white fw-semibold"> (+255)-623101586  </span>
              </p>
